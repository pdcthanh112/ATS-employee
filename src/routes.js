...
const ViewProfilePage = import('./views/Employee/Profile/ViewProfile/ViewProfile')
const ChangePasswordPage = import('./views/Employee/ChangePassword/ChangePassword')
const CandidatePage = import('./views/Candidate/CandidatePage/CandidatePage')
const RecruitmentPlanPage = import('./views/Recuirment/RecruitmentPlan/RecruitmentPlanPage/RecruitmentPlanPage')
const PlanDetailPage = import('./views/Recuirment/PlanDetail/PlanDetailPage/PlanDetailPage')
const RecruitmentRequestPage = import('./views/Recuirment/RecruitmentRequest/RecruitmentRequestPage/RecruitmentRequestPage')
const ExpiredRecruitmentRequestPage = import('./views/Recuirment/RecruitmentRequest/ExpiredRecruitmentRequest/ExpiredRecruitmentRequest')
const InterviewSchedulePage = import('./views/Interview/InterviewSchedule/InterviewSchedulePage/InterviewSchedulePage')
const InterviewDetailPage = import('./views/Interview/InterviewDetail/InterviewDetailPage/InterviewDetailPage')
const DepartmentInterviewPage = import('./views/Interview/DepartmentInterview/DepartmentInterview')
const CurriculumVitaePage = import('./views/CurriculumVitae/CurriculumVitaePage')
const JobApplyPage = import('./views/JobApply/JobApplyPage/JobApplyPage')
const ViewJobApplyPage = import('./views/JobApply/ViewJobApply/ViewJobApply')
const NotificationPage = import('./views/Notification/NotificationPage/NotificationPage')
const StatisticsPage = import('./views/Statistics/StatisticsPage')
