        ...
        <div className='header-menu'>
          <div className="dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu_header">
              <a href='/#/manage-profile/view-profile'><div className='header-menu-item'><i className="fa-regular fa-address-card mr-2 text-[#60d860]"></i>Personal information</div></a>
              <a href='/#/change-password'><div className='header-menu-item'><i className="fa-sharp fa-solid fa-shield-halved mr-2 text-[#60d860]"></i>Change password</div></a>
              <Link to='/#/logout' onClick={handleLogout}><div className='header-menu-item hover:text-[#000]' style={{ marginTop: 15, marginBottom: 10 }}><i className="fa-solid fa-arrow-right-from-bracket mr-2 text-[#ff5858] "></i>Log out</div></Link>
            </ul>
          </div>
        </div>
      </div>
